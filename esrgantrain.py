...
class Trainer:
    ...
    def train(self, train_dataset, valid_dataset, steps, evaluate_every=1000, save_best_only=False):
        ...
        pre_writer = tf.summary.create_file_writer('logs/esr_pretrain')
...
class ESrganGeneratorTrainer(Trainer):
    def __init__(self,
                 model,
                 checkpoint_dir,
                 learning_rate=1e-4):
...
class ESrganTrainer:
    ...
    def __init__(self,
                 ...
                 checkpoint_dir = './ckpt/esrgan'):

        self.now = None

        if content_loss == 'VGG22':
            self.vgg = esrgan.vgg_22()
        elif content_loss == 'VGG54':
            self.vgg = esrgan.vgg_54()
        else:
    ...
    def train(self, train_dataset, evaluate_every=20, steps=200000):
        ...
        gan_writer = tf.summary.create_file_writer('logs/esrgan')
